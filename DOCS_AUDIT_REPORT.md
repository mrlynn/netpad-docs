...
1. **Performance Instrumentation** - New in v4.14.0, needs dedicated documentation
2. **In-App Help System** - 100+ help topics, context-aware search needs docs
3. **Extension System** - Open core architecture documentation
